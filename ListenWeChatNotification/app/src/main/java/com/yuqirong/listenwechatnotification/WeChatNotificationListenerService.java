...
public class WeChatNotificationListenerService extends NotificationListenerService {
    ...
    public void onNotificationPosted(StatusBarNotification sbn) {
        ...
        if (notification == null) {
            Toast.makeText(getApplicationContext(),"notification is null",Toast.LENGTH_LONG).show();
            return;
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            if (extras != null) {
                ...
                Toast.makeText(getApplicationContext(),"title="+title+";content="+content+";pkgname="+sbn.getPackageName(),Toast.LENGTH_LONG).show();
